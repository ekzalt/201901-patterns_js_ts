...
Factory Pattern `./patterns/callback`
...
В JavaScript принято в Callback передавать последним аргументом, а в сам Callback передавать2 аргумента. Первый - это всегда объект возможной ошибки, а второй - возможный результат.
