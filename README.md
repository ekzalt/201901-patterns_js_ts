...
В JavaScript принято Callback передавать последним аргументом. А в сам Callback передавать 2 аргумента: первый - это всегда объект возможной ошибки, а второй - возможный результат.
...
1. когда новые данные внедряются в объект-наблюдатель (подписчик).
2. когда подписчик нотифицируется, что новые данные есть, и обращается к ним сам, когда ему удобно.
